...
Why is this important? bcs this one of the identified illegal methods that SHF had to hide SI and reset FTDs.

What this means? I have no idea but speculating a little bit here we might have some OCC action over those overwriting of puts (Melvin maybe? i saw a post where his location was permanent closed in google). Could it be the SARS situation where gamestop forced some dumb ass to be taken down?

If so what will happen with \~300k+ put contracts (married puts)? this is \~30M+ shares that must be handled somehow (cover time?)

Can someone please check this in a greater detail?
...
This post is from Nov 13 2014 so i would say is not some FUD / Shill work there.

u/pinkcatsonacid do you think we can get this to Dr. T or u/dlauer and see if this is even possible and can be related to the upcoming shareholder voting.
...
As of 2021-06-07 they have reappeared. check image bellow. Not sure what happened, maybe it was a glitch. Either way i consider this issue close and done.

2021-07-16 -> OTM PUTS = 392,939 \~= 39 Million shares

2022-01-21 -> OTM PUTS = 262,255 \~= 26 Million shares

&#x200B;

https://preview.redd.it/hrktqpo4pu371.png?width=2728&format=png&auto=webp&s=f4a0e88ab2614cd0a966b763612b70b6c618acd7
