...
Any non-disclosure agreement is null and void if it is used to cover up illegal activity (such as active market manipulation).

The SEC is offering quite handsome rewards for whistleblowers.
...
So as not to get prematurely disappeared, I would recommend NOT using a work computer, NOR using a private internet connection, but rather using a VPN from a public access point... just my 2ct, you do you...