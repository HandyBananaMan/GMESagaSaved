...
For those who don't know what Failures to Deliver (FTDs) are please [watch this video first](https://www.youtube.com/watch?v=I0WXg5T3cBE) for a very basic understanding of what is going on.

# SEC FTD data

The SEC reports FTD data bi-monthly on their [website](https://www.sec.gov/data/foiadocsfailsdatahtm). This cannot be the complete data as redditors are figuring out that they are in the pockets off Wall Street.
...
In 2019 [Richard Evans did a lecture on naked shorting and FTDs](https://www.youtube.com/watch?v=ncq35zrFCAg) in ETFs that is on YouTube. This is university level and very dense so come prepared to this video.
